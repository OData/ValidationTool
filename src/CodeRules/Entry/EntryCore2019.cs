...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.2019
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore2019 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Each declared property defined on a ComplexType MUST be represented as a child element (in the data service namespace defined in Common Serialization Rules for XML-based Formats (section 2.2.6.1)) of the element representing the ComplexType as a whole.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (complexTypeProperties.Count > 0)
            {
                ...
                // Verify that all Complex Type properties are represent under m:properties
                foreach (var complexTypeProperty in complexTypePropertyList)
                {
                    ...
                    if (nodeList.Count == complexTypeProperty.Count())
                    {
                        passed = true;
                    }
                    else
