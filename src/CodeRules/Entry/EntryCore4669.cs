...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4669
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4669 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The href attribute of atom:link element for stream properties MUST contain the URL.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (var xe in StreamTypeResultList)
            {
                ...
                if (xereadlink != null)
                {
                    string href = xereadlink.GetAttributeValue(@"href");
                    if (href == null)
                    {
                        passed = false;
                        break;
                ...
                if (xeeditlink != null)
                {
                    string href = xeeditlink.GetAttributeValue(@"href");
                    if (href == null)
                    {
                        passed = false;
                        break;
