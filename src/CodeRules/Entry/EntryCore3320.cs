...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.3320
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore3320 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The service MAY omit the odata.navigationLinkUrl annotation if odata.metadata=minimal has been specified on the request and the navigation link matches this computed value in V3.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            {
                if (jProp.Name.EndsWith(Constants.OdataNavigationLinkPropertyNameSuffix + "Url"))
                {
                ...
                if (passed == null)
                {
                    ...
                    if (fullEntry != null)
                    {
                        ...
                        else if (fullEntry[Constants.OdataId] != null)
                        {
                            ...
                            if (id.LastIndexOf(@"/") > 0)
                            {
                                // if odata.id is absolute path, get the related path.
