...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.3102
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore3102 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The association link for a navigation property is only represented if the client requests odata=fullmetadata in V3.";
            }
        }
