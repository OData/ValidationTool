...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4658
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4658 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"If a collection of entities can be related in an expanded navigation property, it MUST be represented as an atom:feed.";
            }
        }
