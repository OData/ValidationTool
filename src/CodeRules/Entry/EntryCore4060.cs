...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4060
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4060 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The odata.mediaContentType annotation MAY be included.";
            }
        }
