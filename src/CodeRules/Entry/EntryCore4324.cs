...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4324
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4324 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "In geography and geometry values, the coordinates member of a LineString can have zero or more positions";
            }
        }
