...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4323
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4323 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "In geography and geometry values, keys SHOULD be ordered with type first, then coordinates, then any other keys.";
            }
        }
