...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4624
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4624 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"For properties that represent a collection of complex types, the URI fragment specified in the metadata:type attribute is the namespace-qualified or alias-qualified element type prefixed with 'Collection' and enclosed in parenthesis.";
            }
        }
