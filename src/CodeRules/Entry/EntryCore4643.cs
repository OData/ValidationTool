...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4643
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4643 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The association link is a URL.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (XmlNode node in xmlNodes)
            {
                ...
                if (navigPropNames.Contains(node.Attributes[@"title"].Value) &&
                    @"application/xml" == node.Attributes[@"type"].Value)
                {
                    passed = true;
