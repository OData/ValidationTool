...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4077
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4077 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "A property name for an entity instance MUST be the name of the property.";
            }
        }
