...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4088
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4088 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "A complex value MAY have name/value pairs for instance annotations, including odata annotations.";
            }
        }
