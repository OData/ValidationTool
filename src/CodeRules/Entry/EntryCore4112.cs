...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4112
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4112 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The navigation property MAY be annotated with odata.nextlink.";
            }
        }
                ...
                foreach (JProperty jProp in jProps)
                {
                    if (navigPropNames.Contains(jProp.Name) && jProp.Value.Type == JTokenType.Array)
                    {
                        if (jProp.Next != null)
                        {
                            ...
                            if (nextProp.Name == jProp.Name + odatanextLink)
                            {
                                return true;
                            }
                            else
