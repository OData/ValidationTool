...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4677
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4677 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The rel attribute of atom:link element for Media entity MUST have the string “edit-media” as value.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            string linkFormat = "//atom:link[@rel='edit-media']";
