...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4097
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4097 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The navigation link for a navigation property is only represented if the client requests odata.metadata=full.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            List<string> jNavgPropNames = JsonSchemaHelper.GetAllSpecifiedPropertyNameFromEntry(entry, Constants.OdataNavigationLinkPropertyNameSuffix) as List<string>;
            ...
            if (jNavgPropNames.Count != 0)
            {
                if (context.OdataMetadataType == ODataMetadataType.FullOnly)
                {
                    ...
                    List<string> jNewNavgPropNames = JsonSchemaHelper.GetAllSpecifiedPropertyNameFromEntry(newEntry, Constants.OdataNavigationLinkPropertyNameSuffix) as List<string>;
