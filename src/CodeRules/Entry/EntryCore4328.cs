...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4328
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4328 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The navigation link for a navigation property is represented if the navigation link cannot be computed.";
            }
        }
