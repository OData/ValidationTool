...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4657
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4657 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"If no entity is currently related in an expanded navigation property,  the metadata:inline element is empty.";
            }
        }
