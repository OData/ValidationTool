...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4043
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4043 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The odata.editLink annotation  MUST appear for updatable entities if odata.metadata=full is requested.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (entry != null && entry.Type == JTokenType.Object)
            {
                ...
                {
                    // Verify whether there has an editLink property in current entry or not.
                    if (jProp.Name.Equals(odataEditLink))
                    {
                        passed = true;
                        break;
                    }
