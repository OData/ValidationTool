...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.2001
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore2001 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"If the entity being represented is a Media Link Entry, the value of the ""content_type"" name/value pair MUST be equivalent to the value of the ""type"" attribute on the <atom:content> AtomPub element if the entity was to be represented using the AtomPub [RFC5023] format, instead of JSON.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            // Get the content_type property value
            JObject jsonObject = null;
            string value = null;
            if (context.ResponsePayload.TryToJObject(out jsonObject))
            {
                value = JsonHelper.GetPropertyOfChild(jsonObject, "__metadata", "content_type");
            }
