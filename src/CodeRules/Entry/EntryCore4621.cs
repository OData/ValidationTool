...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4621
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4621 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"For properties that represent a collection of values, the fragment is the namespace-qualified or alias-qualified type name prefixed with Collection and enclosed in parentheses.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            List<string> namesWithCollectionType = AtomSchemaHelper.GetAllNameWithCollectionType(context.MetadataDocument, context.EntityTypeShortName);
