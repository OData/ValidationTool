...
namespace ODataValidator.Rule
{
    ...
    public class EntryCore4241 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The odata.id annotation MUST appear if the entity-id is not identical to the canonical URL of the entity.";
            }
        }
