...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4634
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4634 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The full name of rel attribute must be used in a navigation link; the use of relative URLs in the rel attribute is not allowed.";
            }
        }
