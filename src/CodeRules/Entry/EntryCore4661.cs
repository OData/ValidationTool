...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4661
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4661 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"An entity or its complex type instance MAY contain one or more stream properties";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            passed = StreamTypeResultList.Count != 0;
