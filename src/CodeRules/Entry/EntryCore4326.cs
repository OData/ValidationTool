...
namespace ODataValidator.Rule
{
    ...
    public class EntryCore4326 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "An empty collection of primitive values or complex values is represented as an empty array.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (JProperty jProp in jProps)
            {
                ...
                if (jProp.Value.ToString().Equals("[]"))
                {
                    // Whether the type is array and the count is 0.
