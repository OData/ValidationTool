...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4671
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4671 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The type attribute of atom:link element for stream properties MAY be present.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (var xe in StreamTypeResultList)
            {
                ...
                if (xereadlink != null)
                {
                    string type = xereadlink.GetAttributeValue(@"type");
                    if (type == null)
                    {
                        passed = false;
                        break;
                ...
                if (xeeditlink != null)
                {
                    string type = xeeditlink.GetAttributeValue(@"type");
                    if (type == null)
                    {
                        passed = false;
                        break;
