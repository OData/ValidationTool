...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4322
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4322 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The service MAY omit the odata.associationLink annotation if the association link matches this computed value in V4.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            {
                if (jProp.Name.EndsWith(Constants.OdataAssociationLinkPropertyNameSuffix))
                {
