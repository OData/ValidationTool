...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4717
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4717 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"For non-built in primitive types, the URI of metadata:type for data:[PropertyName] element may simply contain the qualified type name prefixed with hash (#).";
            }
        }
