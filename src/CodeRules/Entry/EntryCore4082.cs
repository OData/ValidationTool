...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Entry.Core.4082
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4082 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Values of type Edm.String are represented as JSON strings.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (entry != null && entry.Type == JTokenType.Object)
            {
                ...
                foreach (JProperty jProp in jProps)
                {
                    ...
                    {
                        if (jProp.Value.Type == JTokenType.String || jProp.Value.Type == JTokenType.Null)
                        {
                            passed = true;
                        }
                        else
