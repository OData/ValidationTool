...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Entry.Core.4662
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntryCore4662 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"Properties that represent streams have a type of Edm.Stream.";
            }
        }
