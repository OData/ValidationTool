...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Delta.Core.4028
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class DeltaCore4028 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The link object MUST include target, the id of the related entity, which may be absolute or relative";
            }
        }
