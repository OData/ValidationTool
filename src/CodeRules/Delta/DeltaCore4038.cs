...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Delta.Core.4038
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class DeltaCore4038 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The deleted-link object MUST include relationship, the name of the relationship property on the parent object.";
            }
        }
