...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Error.Core.4603
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ErrorCore4603 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"When formatting error responses as XML, services SHOULD include a Content-Type response header with the value 'application/xml'.";
            }
        }
