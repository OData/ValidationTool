...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Error.Core.4607
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ErrorCore4607 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The metadata:error element for Error Reponse MUST contain one metadata:code element.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            XmlNodeList xmlNodeList = xmlDoc.SelectNodes(@"/m:error/m:code", nsmgr);
