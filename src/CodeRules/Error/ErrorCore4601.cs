...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Error.Core.4601
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ErrorCore4601 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"In the case of an error being generated in response to a request specifying an Accept header of application/atom+xml, the service MUST respond with an error formatted as XML.";
            }
        }
