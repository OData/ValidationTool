...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Error.Core.4012
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ErrorCore4012 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The value for the innererror name/value pair MUST be an object.";
            }
        }
