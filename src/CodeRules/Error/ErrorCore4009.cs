...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Error.Core.4009
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ErrorCore4009 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The value for the details name/value pair MUST be an array of JSON objects.";
            }
        }
                            ...
                            if (jP.Name == @"details")
                            {
                                if (jP.Value.Type == JTokenType.Array)
                                {
                                    ...
                                    foreach (var jo in jArr)
                                    {
                                        ...
                                        {
                                            passed = false;
                                            info = info = new ExtensionRuleViolationInfo(this.ErrorMessage, context.Destination, context.ResponsePayload);
                                            break;
                                        }
                                    }
                                }
