...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of entension rule for Rule #293
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class PropertyCore2006 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"A collection of ComplexType instances MUST be represented as an array of JSON objects.";
            }
        }
