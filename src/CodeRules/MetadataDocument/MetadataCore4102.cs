...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4102 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The edm:NavigationProperty element MUST include a Type attribute.";
            }
        }
