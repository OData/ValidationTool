...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Metadata.Core.4013
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MetadataCore4013 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The edmx:Reference element MUST specify a Uri attribute.";
            }
        }
