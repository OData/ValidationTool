...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4233 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The name identifies the type definition and MUST be unique within its namespace.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            XmlNodeList schemaList = xmlDoc.SelectNodes("//*[local-name()='Schema']/*[local-name()='TypeDefinition']/parent::*[local-name()='Schema']");
