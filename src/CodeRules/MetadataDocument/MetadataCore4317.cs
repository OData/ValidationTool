...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4317 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The entity type named by the EntityType attribute MUST have a key defined.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (XElement elem in entitySetElems)
            {
                if (null != elem.Attribute("EntityType"))
                {
                    ...
                    var keyProps = MetadataHelper.GetKeyProperties(context.MetadataDocument, entityTypeShortName);
