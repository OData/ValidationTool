...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4267 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The edm:Function element MUST include a Name attribute whose value is a SimpleIdentifier.";
            }
        }
