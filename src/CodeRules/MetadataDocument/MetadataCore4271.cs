...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4271 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The combination of unbound function name and unordered set of parameter names MUST be unique within a namespace.";
            }
        }
