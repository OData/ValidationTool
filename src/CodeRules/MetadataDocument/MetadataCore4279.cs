...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4279 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Bound functions MUST contain at least one edm:Parameter element.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (null != functionElems && functionElems.Any())
            {
                foreach (var functionElem in functionElems)
                {
                    ...
                    var parameterElems = functionElem.XPathSelectElements(xPath, ODataNamespaceManager.Instance);
