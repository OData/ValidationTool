...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4329 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The path can traverse one or more containment navigation properties but the last segment MUST be a non-containment navigation property.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (var navigationPropertyBindingElem in navigationPropertyBindingElems)
            {
                ...
                if (null != node && !node.Data.ContainsTarget)
                {
                    passed = true;
                }
                else
