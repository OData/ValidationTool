...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4264 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The function MUST specify a return type using the edm:ReturnType element.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (null != functionElems && functionElems.Any())
            {
                foreach (var functionElem in functionElems)
                {
                    ...
                    var returnTypeElem = functionElem.XPathSelectElement(xPath, ODataNamespaceManager.Instance);
                    if (null != returnTypeElem)
                    {
                        passed = true;
                    }
                    else
