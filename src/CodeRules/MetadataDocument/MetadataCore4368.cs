...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Metadata.Core.4368
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MetadataCore4368 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The edm:Annotations element MUST include a Target attribute.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            {
                if (annotations.Attribute("Target")!=null)
                {
                    passed = true;
                }
                else
