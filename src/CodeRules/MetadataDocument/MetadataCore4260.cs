...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4260 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "A navigation segment of the EntitySetPath attribute's value names the SimpleIdentifier of the navigation property in an edm:Action element.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            string xPath = "//*[local-name()='Schema']/*[local-name()='Action' and @IsBound='true']";
            ...
            foreach (var actionElem in actionElems)
            {
                ...
                var parameterElem = actionElem.XPathSelectElement(xPath, ODataNamespaceManager.Instance);
                ...
                if (null != actionElem.Attribute("EntitySetPath") && !string.IsNullOrEmpty(entityTypeShortName))
                {
                    string entitySetPathVal = actionElem.GetAttributeValue("EntitySetPath");
