...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4268 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The combination of Bound function name, binding parameter type, and unordered set of non-binding parameter names MUST be unique within a namespace.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            {
                xPath = string.Format("//*[local-name()='Schema' and @Namespace='{0}']/*[local-name()='Function' and @IsBound='true']", @namespace);
