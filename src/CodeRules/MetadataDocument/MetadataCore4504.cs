...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4504 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "With ~/ as an abbreviation for the service root URL, the Metadata Service root URL is ~/$metadata/.";
            }
        }
