...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4312 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The edm:EntitySet element MUST include a Name attribute whose value is a SimpleIdentifier.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (XElement elem in entitySetElems)
            {
                ...
                {
                    string entityTypeShortName = elem.GetAttributeValue("Name");
                    if (entityTypeShortName.IsSimpleIdentifier())
                    {
                        passed = true;
                    }
                    else
