...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4202 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The value of the Name attribute identifies the complex type and MUST be unique within its namespace.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            XmlNodeList schemaList = xmlDoc.SelectNodes("//*[local-name()='Schema']/*[local-name()='ComplexType']/parent::*[local-name()='Schema']");
