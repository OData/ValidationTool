...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4330 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The path can traverse one or more containment navigation properties but there MUST NOT be any non-containment navigation properties prior to the final segment.";
            }
        }
