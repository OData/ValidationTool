...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4128 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "An entity cannot be referenced by more than one containment relationship.";
            }
        }
