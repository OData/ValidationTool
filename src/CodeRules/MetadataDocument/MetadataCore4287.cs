...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4287 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The remaining segments of the entity set path MUST represent navigation segments or type casts in an edm:Function element.";
            }
        }
