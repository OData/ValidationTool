...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Metadata.Core.4394
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MetadataCore4394 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The value of data/time expression MUST NOT contain an end-of-day fragment (24:00:00).";
            }
        }
