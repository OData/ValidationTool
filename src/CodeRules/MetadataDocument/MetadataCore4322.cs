...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4322 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The edm:Singleton element MUST include a Type attribute whose value is the QualifiedName of an entity type in scope.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (XElement elem in singletonElems)
            {
                ...
                {
                    string entityTypeFullName = elem.GetAttributeValue("Type");
