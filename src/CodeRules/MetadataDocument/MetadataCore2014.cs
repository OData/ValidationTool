...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Metadata.Core.2014
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MetadataCore2014 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "If the Entity Type property is being mapped to an AtomPub element, then the FC_NsPrefix attribute MUST NOT be specified.";
            }
        }
