...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4142 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The value of the Property attribute of ReferentialConstraint element MUST be a path expression resolving to a primitive property of the dependent entity type itself or to a primitive property of a complex property of the dependent entity type.";
            }
        }
