...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4340 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The edm:ActionImport element MUST include a QualifiedName value for the Action attribute.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (var actionImportElem in actionImportElems)
            {
                if (null != actionImportElem.Attribute("Action"))
                {
                    ...
                    if (actionAttribVal.IsQualifiedName())
                    {
                        passed = true;
                    }
                    else
