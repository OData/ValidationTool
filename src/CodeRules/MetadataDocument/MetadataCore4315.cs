...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4315 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "An entity set MUST contain only instances of the entity type specified by the EntityType attribute or its subtypes.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (XElement elem in entitySetElems)
            {
                if (null != elem.Attribute("EntityType"))
                {
                    ...
                    if (null != entityTypeElems && entityTypeElems.Count() == 1)
                    {
                        passed = true;
                    }
                    else
