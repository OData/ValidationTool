...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4247 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The edm:Action element MUST include a Name attribute whose value is a SimpleIdentifier.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (var actionElem in actionElems)
            {
                ...
                {
                    string nameAttribVal = actionElem.GetAttributeValue("Name");
