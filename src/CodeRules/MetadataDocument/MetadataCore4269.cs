...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4269 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The combination of Bound function name, binding parameter type, and ordered set of parameter types MUST be unique within a namespace.";
            }
        }
