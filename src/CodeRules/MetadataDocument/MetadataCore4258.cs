...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4258 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The first segment of the entity set path MUST be the name of the binding parameter in an edm:Action element.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            actionElems = actionElems.Where(actElem => null != actElem.Attribute("EntitySetPath")).Select(actElem => actElem);
            if (null == actionElems || !actionElems.Any())
            {
                return passed;
            }
