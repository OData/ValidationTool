...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4215 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The value of the Name of Enumeration identifies the enumeration type and MUST be unique within its namespace.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            XmlNodeList schemaList = xmlDoc.SelectNodes("//*[local-name()='Schema']/*[local-name()='EnumType']/parent::*[local-name()='Schema']");
