...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4140 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "A referential constraint MUST specify a value for the Property attribute.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (null != referentialConstraintElems && referentialConstraintElems.Any())
            {
                foreach (var referentialConstraintElem in referentialConstraintElems)
                {
                    ...
                    {
                        string propertyVal = referentialConstraintElem.GetAttributeValue("Property");
