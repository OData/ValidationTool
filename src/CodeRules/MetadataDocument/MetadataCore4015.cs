...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Metadata.Core.4015
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MetadataCore4015 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The value of the Uri attribute in edmx:Reference SHOULD be a URL that locates a CSDL document describing the referenced model.";
            }
        }
