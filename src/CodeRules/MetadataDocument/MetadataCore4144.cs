...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4144 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "A referential constraint MUST specify a value for the ReferencedProperty attribute.";
            }
        }
