...
namespace ODataValidator.Rule
{
    ...
    public class MetadataCore4138 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "If the navigation property on which the referential constraint is defined or the principal property is nullable, then the dependent property MUST be nullable.";
            }
        }
                ...
                foreach (var referentialConstraintElem in referentialConstraintElems)
                {
                    if (null != referentialConstraintElem.Attribute("ReferencedProperty"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(propertyVal))
                        {
                            ...
                            if (navigationNullableValue == null || !string.IsNullOrEmpty(navigationNullableValue) && navigationNullableValue.Equals("true"))
                            {
                                navigationNullable = true;
                            }

                            bool principalPropNullable = false;
                            ...
                            if (MetadataHelper.ResolveToProperty(principalPropPath, xmlDoc, out principalProp))
                            {
                                ...
                                if (principalProp.Attributes["Nullable"] == null ||
                                    (principalProp.Attributes["Nullable"] != null && principalProp.Attributes["Nullable"].Value.Equals("true")))
                                {
                                    principalPropNullable = true;
                                }
                            }
                            else
                            {
                            ...
                            if (dependentProperty != null)
                            {
                                if (navigationNullable || principalPropNullable)
                                {
                                    ...
                                    if (dependentPropNullableValue == null
                                        || dependentPropNullableValue != null && dependentPropNullableValue.Equals("true"))
                                    {
                                        passed = true;
                                    }
                                    else
