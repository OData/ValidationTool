...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Metadata.Core.4178
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MetadataCore4178 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"An entity type that is not abstract MUST either contain exactly one edm:Key element or inherit its key from its base type.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            foreach (XmlNode entityType in entityTypeCollection)
            {
                ...
                {
                    XmlNodeList keys = entityType.SelectNodes(@"./*[local-name()='Key']");
