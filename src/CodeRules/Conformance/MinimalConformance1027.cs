...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Minimal.Conformance.1027
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MinimalConformance1027 : ConformanceMinimalExtensionRule
    {
        /// <summary>
        /// Gets rule name
        /// </summary>
        public override string Name
        {
            get
            {
                return "Minimal.Conformance.1027";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return "27. SHOULD support DELETE to set an individual property to null (section 11.4.9.2)";
            }
        }
