...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Minimal.Conformance.1011
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MinimalConformance1011 : ConformanceMinimalExtensionRule
    {
        /// <summary>
        /// Gets rule name
        /// </summary>
        public override string Name
        {
            get
            {
                return "Minimal.Conformance.1011";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return "11. MUST NOT violate any other OData-defined semantics.";
            }
        }
