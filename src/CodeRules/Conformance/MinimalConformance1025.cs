...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Minimal.Conformance.1025
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class MinimalConformance1025 : ConformanceMinimalExtensionRule
    {
        /// <summary>
        /// Gets rule name
        /// </summary>
        public override string Name
        {
            get
            {
                return "Minimal.Conformance.1025";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return "25. MUST support Upserts (section 11.4.4)";
            }
        }
