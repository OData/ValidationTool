...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Advanced.Conformance.101106
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class AdvancedConformance101106 : ConformanceAdvancedExtensionRule
    {
        /// <summary>
        /// Gets rule name
        /// </summary>
        public override string Name
        {
            get
            {
                return "Advanced.Conformance.101106";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return "4). The service MUST include the Content-ID header in each response with the same value that the client specified in the corresponding request. (section 11.7.4)";
            }
        }
