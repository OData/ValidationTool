...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Intermediate.Conformance.1008
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class IntermediateConformance1008 : ConformanceIntermediateExtensionRule
    {
        /// <summary>
        /// Gets rule name
        /// </summary>
        public override string Name
        {
            get
            {
                return "Intermediate.Conformance.1008";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return "8. SHOULD publish metadata at $metadata according to [OData-CSDL] (section 11.1.2)";
            }
        }
