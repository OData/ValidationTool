...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to query an entity with filter Greater Than.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_FilterGreaterThan : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_FilterGreaterThan";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter (Greater Than)";
            }
        }
