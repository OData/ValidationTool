...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to query an entity with filter not.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_FilterNot : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter (Not)";
            }
        }
