...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to query an entity with filter or.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_FilterOr : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter (Or)";
            }
        }
