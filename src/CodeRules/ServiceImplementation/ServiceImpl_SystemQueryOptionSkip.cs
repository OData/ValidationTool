...
namespace ODataValidator.Rule
{
    ...
    public class ServiceImpl_SystemQueryOptionSkip : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_SystemQueryOptionSkip";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$skip";
            }
        }
