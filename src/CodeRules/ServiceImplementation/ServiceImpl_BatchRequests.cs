...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implementation rule for batch requests.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_BatchRequests : ServiceImplExtensionRule
    {
        /// <summary>
        /// Gets rule name
        /// </summary>
        public override string Name
        {
            get
            {
                return "ServiceImpl_BatchRequests";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",Batch Requests";
            }
        }
        ...
        public override ServiceImplCategory CategoryInfo
        {
            get
            {
                return new ServiceImplCategory(ServiceImplCategoryName.BatchRequests, null);
            }
        }
