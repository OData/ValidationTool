...
namespace ODataValidator.Rule
{
    ...
    public class ServiceImpl_SystemQueryOptionFilter_Trim : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_SystemQueryOptionFilter_Trim";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter(trim)";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (null != resp && HttpStatusCode.OK == resp.StatusCode)
            {
                ...
                url = string.Format("{0}?$filter=trim({1}) eq '{2}'", url, propName, propVal);
                ...
                if (null != resp && HttpStatusCode.OK == resp.StatusCode)
                {
                    ...
                    {
                        passed = et[propName].ToString().Trim() == propVal;
                    }
                }
                else
                {
