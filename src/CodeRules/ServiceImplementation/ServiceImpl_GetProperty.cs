...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to Get Property.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_GetProperty : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_GetProperty";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",Get Property";
            }
        }
