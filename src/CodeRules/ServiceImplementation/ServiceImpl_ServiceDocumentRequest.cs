...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to request the service document.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_ServiceDocumentRequest : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_ServiceDocumentRequest";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",Service Document Request";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if(!string.IsNullOrEmpty(context.ServiceDocument))
            {
                passed = true;
            }
            else
