...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to query an entity with filter Less Than.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_FilterLessThan : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_FilterLessThan";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter (Less Than)";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            string pattern = "{0}/{1}?$filter={2} lt {3}";
            ...
            {
                passed = false;
                detail.ErrorMessage = "Request failed with system query option $filter lt.";
                return passed;
            }
            ...
            {
                passed = false;
                detail.ErrorMessage = "The service does not return a valid response for system query option $filter lt.";
                return passed;
            }
            ...
            {
                passed = false;
                detail.ErrorMessage = "The service does not execute an accurate result with system query option $filter lt.";
            }
