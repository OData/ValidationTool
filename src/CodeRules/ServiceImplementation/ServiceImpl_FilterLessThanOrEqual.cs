...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to query an entity with filter Less Than or Equal.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_FilterLessThanOrEqual : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_FilterLessThanOrEqual";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter (Less Than or Equal)";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            {
                detail.ErrorMessage = "Cannot find an appropriate entity-set which supports Less Than or Equal system query options in the service.";
            ...
            string pattern = "{0}/{1}?$filter={2} le {3}";
            ...
            {
                passed = false;
                detail.ErrorMessage = "Request failed with system query option $filter le.";
                return passed;
            }
            ...
            {
                passed = false;
                detail.ErrorMessage = "The service does not return a valid response for system query option $filter le.";
                return passed;
            }
            ...
            {
                passed = false;
                detail.ErrorMessage = "The service does not execute an accurate result with system query option $filter le.";
            }
