...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to query an entity lambda expression All.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_FilterAll : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter (all)";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            HttpStatusCode? statusCode = VerificationHelper.VerifyLambdaOperators(context, LambdaOperatorType.All, out passed, out info);
            if (info != null)
            {
