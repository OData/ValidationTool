...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to query an entity with filter Equals.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_FilterEquals : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_FilterEquals";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter (Equals)";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            {
                passed = false;
                detail.ErrorMessage = "Request failed with system query option $filter eq.";
                return passed;
            }
            ...
            {
                passed = false;
                detail.ErrorMessage = "The service does not return a valid response for system query option $filter eq.";
                return passed;
            }
            ...
            {
                passed = false;
                detail.ErrorMessage = "The service does not execute an accurate result with system query option $filter eq.";
            }
