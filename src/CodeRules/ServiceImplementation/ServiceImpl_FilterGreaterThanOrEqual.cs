...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of service implemenation feature to query an entity with filter Greater Than or Equal.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class ServiceImpl_FilterGreaterThanOrEqual : ServiceImplExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "ServiceImpl_FilterGreaterThanOrEqual";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return this.CategoryInfo.CategoryFullName + ",$filter (Greater Than or Equal)";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            {
                detail.ErrorMessage = "Cannot find an appropriate entity-set which supports Greater Than or Equal system query options in the service.";
            ...
            Int64 propVal = entities[0].Value<Int64>(primitivePropName);

            string pattern = "{0}/{1}?$filter={2} ge {3}";
            ...
            {
                passed = false;
                detail.ErrorMessage = "Request failed with system query option $filter ge.";
                return passed;
            }
            ...
            {
                passed = false;
                detail.ErrorMessage = "The service does not return a valid response for system query option $filter ge.";
                return passed;
            }
            ...
            {
                passed = false;
                detail.ErrorMessage = "The service does not execute an accurate result with system query option $filter ge.";
            }
