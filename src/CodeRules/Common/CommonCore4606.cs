...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4606_IndividualProperty : CommonCore4606
    {
        /// <summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4606
    /// </summary>
    public abstract class CommonCore4606 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Requests using $format with value atom MUST receive the MIME type application/xml for all other resources except entities and collections of entities, references, or changes, service document.";
            }
        }
