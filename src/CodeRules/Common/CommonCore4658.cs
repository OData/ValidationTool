...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4658_Feed : CommonCore4658
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4658_Entry : CommonCore4658
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4658_DeltaResponse : CommonCore4658
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4658
    /// </summary>
    public abstract class CommonCore4658 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Requests using $format with value application/atom+xml MUST receive the MIME type application/atom+xml for entities and collections of entities, references, or changes.";
            }
        }
