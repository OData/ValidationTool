...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4717_Entry : CommonCore4717
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4717_Feed : CommonCore4717
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4717
    /// </summary>
    public abstract class CommonCore4717 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The title name/value pair in bound function contains the function or action title as a string.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (functionImportNames.Count > 0)
            {
                ...
                {
                    isFunctionProperty = JsonParserHelper.isFunctionOrActionProperty(functionImportNames, jProp, metadataSchema);
