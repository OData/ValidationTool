...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4520_Feed : CommonCore4520
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4520_Entry : CommonCore4520
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4520
    /// </summary>
    public abstract class CommonCore4520 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The full list of annotations that may appear in an odata.metadata=full response are include odata.type.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (context.PayloadType == RuleEngine.PayloadType.Feed || context.PayloadType == RuleEngine.PayloadType.Entry)
            {
                ...
                {
                    if (jo[odataTypeAnnotation] != null)
                    {
                        passed = true;
                    }
                    else
                ...
                else 
                {
                    ...
                    {
                        if (ob[odataTypeAnnotation] != null)
                        {
                            passed = true;
                        }
                        else
