...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4629_Feed : CommonCore4629
    {
        /// <summary>
    ...
    /// <summary>
    /// Class of entension rule for Common.Core.4629
    /// </summary>
    public abstract class CommonCore4629 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"When annotating a feed, annotation elements MUST be direct children of the atom:feed element.";
            }
        }
