...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4516_Feed : CommonCore4516
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4516_Entry : CommonCore4516
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4516
    /// </summary>
    public abstract class CommonCore4516 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The full list of annotations that may appear in an odata.metadata=full response are include odata.readLink.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            string odataReadLinkAnnotation = Constants.V4OdataReadLink;

            if (context.Version == ODataVersion.V3)
            {
                odataReadLinkAnnotation = Constants.OdataReadLink;
            }   
            ...
            if (context.PayloadType == RuleEngine.PayloadType.Feed || context.PayloadType == RuleEngine.PayloadType.Entry)
            {
                ...
                {
                    if (jo[odataReadLinkAnnotation] != null)
                    {
                        passed = true;
                    }
                    else
                ...
                else 
                {
                    ...
                    {
                        if (ob[odataReadLinkAnnotation] != null)
                        {
                            passed = true;
                        }
                        else
