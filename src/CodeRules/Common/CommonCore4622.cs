...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4622_IndividualProperty : CommonCore4622
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4622_Feed : CommonCore4622
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4622_Entry : CommonCore4622
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4622_EntityRef : CommonCore4622
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4622
    /// </summary>
    public abstract class CommonCore4622 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"If the type of the annotation value being specified is anything other than Edm.String the metadata:annotation element MUST contain a metadata:type attribute.";
            }
        }
