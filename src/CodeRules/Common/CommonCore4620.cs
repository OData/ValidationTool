...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4620_IndividualProperty : CommonCore4620
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4620_Feed : CommonCore4620
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4620_Entry : CommonCore4620
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4620_EntityRef : CommonCore4620
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4620
    /// </summary>
    public abstract class CommonCore4620 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The target attribute of metadata:annotation element for MAY be used to specify annotation target.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            {
                if (annotatEle.Attributes["target"] != null)
                {
                    passed = true;
                }
                else
