...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4650
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4650 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Service MUST support the application/xml media types in the Accept header.";
            }
        }
