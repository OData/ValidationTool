...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4651
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4651 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Service MUST support the application/atomsvc+xml media types in the Accept header.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            string acceptHeader = Constants.ContentTypeAtomSvc;
