...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4515_Feed : CommonCore4515
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4515_Entry : CommonCore4515
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4515
    /// </summary>
    public abstract class CommonCore4515 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The full list of annotations that may appear in an odata.metadata=full response are include odata.etag.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            string odataEtagAnnotation = Constants.V4OdataEtag;

            if (context.Version == ODataVersion.V3)
            {
                odataEtagAnnotation = Constants.OdataEtag;
            }   
            ...
            if (context.PayloadType == RuleEngine.PayloadType.Feed || context.PayloadType == RuleEngine.PayloadType.Entry)
            {
                ...
                {
                    if (jo[odataEtagAnnotation] != null)
                    {
                        passed = true;
                    }
                    else
                ...
                else 
                {
                    ...
                    {
                        if (ob[odataEtagAnnotation] != null)
                        {
                            passed = true;
                        }
                        else
