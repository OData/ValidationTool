...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4123
    /// </summary>
    [Export(typeof(ExtensionRule))]
    class CommonCore4123 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"When annotating a name/value pair for which the value is represented as a JSON object, each annotation is represented as a single name/value pair.";
            }
        }
