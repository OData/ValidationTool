...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4722_Entry : CommonCore4722
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4722_Feed : CommonCore4722
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4722
    /// </summary>
    public abstract class CommonCore4722 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The target name/value pair in bound action contains a bound function or action URL.";
            }
        }
