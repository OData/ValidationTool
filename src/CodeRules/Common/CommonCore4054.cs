...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4054_Entry : CommonCore4054
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4054_Feed : CommonCore4054
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4054
    /// </summary>
    public abstract class CommonCore4054 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The odata.mediaEditLink annotation contains a URL.";
            }
        }
