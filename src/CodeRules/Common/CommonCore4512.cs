...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4512_Feed : CommonCore4512
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4512_EntityRef : CommonCore4512
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4512
    /// </summary>
    public abstract class CommonCore4512 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The full list of annotations that may appear in an odata.metadata=full response are include odata.nextLink.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (context.PayloadType == RuleEngine.PayloadType.Feed || (context.PayloadType == RuleEngine.PayloadType.EntityRef && jo[Constants.Value] != null))
            {
                ...
                if (jo[odataNextLinkAnnotation] != null)
                {
                    passed = true;
                }
                else
