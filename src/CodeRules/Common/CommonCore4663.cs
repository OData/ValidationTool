...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4663_IndividualProperty : CommonCore4663
    {
        /// <summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4663
    /// </summary>
    public abstract class CommonCore4663 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Requests using an Accept header with value application/atom+xml MUST receive the MIME type application/xml for all other resources except entities and collections of entities, references, or changes, service document.";
            }
        }
