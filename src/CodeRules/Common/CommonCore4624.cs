...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4624_IndividualProperty : CommonCore4624
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4624_Feed : CommonCore4624
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4624_Entry : CommonCore4624
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4624_EntityRef : CommonCore4624
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4624
    /// </summary>
    public abstract class CommonCore4624 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"If the type of the annotation value is anything other than Edm.String, then the annotation element MUST contain the metadata:type attribute of metadata:annotation element.";
            }
        }
