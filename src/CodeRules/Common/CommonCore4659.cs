...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4659_Feed : CommonCore4659
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4659_Entry : CommonCore4659
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4659_DeltaResponse : CommonCore4659
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4659
    /// </summary>
    public abstract class CommonCore4659 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Requests using an Accept header with value application/atom+xml MUST receive the MIME type application/atom+xml for entities and collections of entities, references, or changes.";
            }
        }
