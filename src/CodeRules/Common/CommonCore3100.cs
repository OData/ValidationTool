...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore3100_ServiceDoc : CommonCore3100
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore3100_Entry : CommonCore3100
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore3100_Feed : CommonCore3100
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore3100_DeltaResponse : CommonCore3100
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore3100_EntityRef : CommonCore3100
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore3100_Other : CommonCore3100
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.3100
    /// </summary>
    public abstract class CommonCore3100 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"Responses MUST include the odata.metadata parameter(odata=fullmetadata, odata=minimalmetadata or odata=nonemetadata) to specify the amount of metadata included in the response in V3.";
            }
        }
