...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4017_Entry : CommonCore4017
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4017_Feed : CommonCore4017
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public abstract class CommonCore4017 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"To support streaming scenarios the following payload ordering constraints have to be met: Annotations for navigation properties MUST appear after all structural properties.";
            }
        }
