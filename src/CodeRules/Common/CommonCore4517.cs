...
namespace ODataValidator.Rule
{
    ...
    public class CommonCore4517_Feed : CommonCore4517
    {
        /// <summary>
    ...
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4517_Entry : CommonCore4517
    {
        /// <summary>
        /// Gets the payload type to which the rule applies.
        /// </summary>
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4517
    /// </summary>
    public abstract class CommonCore4517 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The full list of annotations that may appear in an odata.metadata=full response are include odata.editLink.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            string odataEditLinkAnnotation = Constants.V4OdataEditLink;

            if (context.Version == ODataVersion.V3)
            {
                odataEditLinkAnnotation = Constants.OdataEditLink;
            }   
            ...
            if (context.PayloadType == RuleEngine.PayloadType.Feed || context.PayloadType == RuleEngine.PayloadType.Entry)
            {
                ...
                {
                    if (jo[odataEditLinkAnnotation] != null)
                    {
                        passed = true;
                    }
                    else
                ...
                else 
                {
                    ...
                    {
                        if (ob[odataEditLinkAnnotation] != null)
                        {
                            passed = true;
                        }
                        else
