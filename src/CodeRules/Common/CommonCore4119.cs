...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4119
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4119 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"Annotations are always expressed as name/value pairs.";
            }
        }
