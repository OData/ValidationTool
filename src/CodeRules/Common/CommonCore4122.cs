...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Common.Core.4122
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class CommonCore4122 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"When annotating a name/value pair for which the value is represented as a JSON object, each annotation is placed within the object.";
            }
        }
