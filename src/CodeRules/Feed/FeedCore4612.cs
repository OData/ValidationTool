...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Feed.Core.4612
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class FeedCore4612 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The contents of the href attribute of a next link element for Collection of Entities SHOULD be treated as an opaque URL that can be used to fetch the next set of results.";
            }
        }
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (null != nextLinkNode)
            {
                ...
                if (null != linkHrefNode)
                {
                    ...
                    string[] hrefParts = href.Split(new string[] { "?$skiptoken=" }, StringSplitOptions.RemoveEmptyEntries);
                    ...
                    if (hrefParts != null && hrefParts.Length == 2
                        ...
                        && Int32.TryParse(hrefParts[1], out skipToken) && skipToken > 0)
                    {
                        passed = true;
                    }
                    else
