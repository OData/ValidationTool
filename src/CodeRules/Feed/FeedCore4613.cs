...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Feed.Core.4613
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class FeedCore4613 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The contents of the href of a delta link element for Collection of Entities should be treated as an opaque URL that can be used to fetch subsequent changes.";
            }
        }
