...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Feed.Core.4600
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class FeedCore4600 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "If the root of the response is an atom:feed element, it MUST have a metadata:context attribute.";
            }
        }
