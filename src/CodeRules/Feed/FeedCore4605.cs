...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Feed.Core.4605
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class FeedCore4605 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The metadata:count element MAY be greater than the number of entries in the feed, if server-side paging has been applied.";
            }
        }
