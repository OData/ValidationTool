...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Feed.Core.4607
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class FeedCore4607 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The atom:feed element for Collection of Entities MAY contain a self link.";
            }
        }
