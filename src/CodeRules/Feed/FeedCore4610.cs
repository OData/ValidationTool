...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Feed.Core.4610
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class FeedCore4610 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "In a valid OData Atom response Payload the atom:link element representing a next link or a delta link MAY be positioned after the last atom:entry or metadata:ref element.";
            }
        }
