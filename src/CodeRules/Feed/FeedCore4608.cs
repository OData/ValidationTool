...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for Feed.Core.4608
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class FeedCore4608 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "The atom:feed element for Collection of Entities MAY contain a next link.";
            }
        }
