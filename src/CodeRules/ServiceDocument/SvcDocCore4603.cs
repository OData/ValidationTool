...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4603
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4603 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The value of metadata:context attribute is the URL that returns the metadata document of the service.";
            }
        }
