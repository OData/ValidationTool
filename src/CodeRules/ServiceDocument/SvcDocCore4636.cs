...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4636
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4636 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return "Requests using $format with value application/atom+xml MUST receive the MIME type application/xml for the service document.";
            }
        }
