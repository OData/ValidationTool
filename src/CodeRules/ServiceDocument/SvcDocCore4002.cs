...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4002
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4002 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The value of the odata.context property MUST be the URL of the metadata document, without any fragment part in V4.";
            }
        }
            ...
            if (!context.OdataMetadataType.Equals("none"))
            {
                ...
                if (inner != null && inner.Type == JTokenType.Object)
                {
                    ...
                    if (et.Name.Equals(Constants.OdataV4JsonIdentity))
                    {
                        ...
                        // Verify the end of the context Url is $metadata and it's a valid url.
                        passed = contextValue.EndsWith(Constants.Metadata) && isValidUrl;
