...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4633
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4633 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The metadata:service-document element MUST contain an href attribute.";
            }
        }
