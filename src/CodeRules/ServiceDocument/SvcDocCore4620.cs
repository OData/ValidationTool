...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4620
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4620 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The metadata:function-import element MUST contain an atom:title element.";
            }
        }
...
//</service>");
            ...
            XmlNodeList collectionNodes = xmlDoc.SelectNodes(@"//app:workspace/metadata:function-import", nsmgr);
