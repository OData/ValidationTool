...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4626
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4626 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The metadata:singleton element MUST contain an atom:title element.";
            }
        }
