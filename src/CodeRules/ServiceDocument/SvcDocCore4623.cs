...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4623
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4623 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"The metadata:singleton element MUST contain an href attribute.";
            }
        }
