...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4632
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4632 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"OData represents related service documents as metadata:service-document elements contained within the app:workspace element.";
            }
        }
