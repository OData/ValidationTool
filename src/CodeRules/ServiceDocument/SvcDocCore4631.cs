...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for SvcDoc.Core.4631
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class SvcDocCore4631 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Description
        {
            get
            {
                return @"OData represents singletons as metadata:singleton elements contained within the app:workspace element.";
            }
        }
