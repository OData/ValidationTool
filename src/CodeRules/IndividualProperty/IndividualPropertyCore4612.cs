...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for IndividualProperty.Core.4612
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class IndividualPropertyCore4612 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "IndividualProperty.Core.4612";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return @"The metadata:value element for Collection of Scalar Values MAY have a metadata:metadata-etag attribute.";
            }
        }
        ...
        /// <summary>
        /// Verify IndividualProperty.Core.4612
        /// </summary>
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (root.LocalName.Equals("value") && root.NamespaceURI.Equals(Constants.NSMetadata))
            {
                ...
                if (root.Attributes["metadata-etag", Constants.NSMetadata] != null)
                {
                    passed = true;
                }
                else
