...
namespace ODataValidator.Rule
{
    ...
    /// A property that is of a collection type is represented similarly as an object with a single name/value pair whose name is value.
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class IndividualPropertyCore4202 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "IndividualProperty.Core.4202";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return @"In individual property, a property that is of a collection type is represented as an object with a single name/value pair whose name is value and whose value is the JSON representation of a collection of complex type or collection of primitive values.";
            }
        }
