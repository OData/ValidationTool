...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for IndividualProperty.Core.4608
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class IndividualPropertyCore4608 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "IndividualProperty.Core.4608";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return @"The metadata:value element for Collection of Scalar Values MUST NOT contain a metadata:null attribute.";
            }
        }
        ...
        /// <summary>
        /// Verify IndividualProperty.Core.4608
        /// </summary>
        ...
        public override bool? Verify(ServiceContext context, out ExtensionRuleViolationInfo info)
        {
            ...
            if (root.LocalName.Equals("value") && root.NamespaceURI.Equals(Constants.NSMetadata))
            {
                if (root.Attributes["context", Constants.NSMetadata] != null)
                {
                    ...
                    {
                        if(root.Attributes["null", Constants.NSMetadata] == null)
                        {
                            passed = true;
                        }
                        else
