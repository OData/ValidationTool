...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for IndividualProperty.Core.4605
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class IndividualPropertyCore4605 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "IndividualProperty.Core.4605";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return @"The metadata:value element for Single Scalar Value MAY have a metadata:metadata-etag attribute.";
            }
        }
        ...
        /// <summary>
        /// Verify IndividualProperty.Core.4605
        /// </summary>
