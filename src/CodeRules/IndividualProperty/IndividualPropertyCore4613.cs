...
namespace ODataValidator.Rule
{
    ...
    /// <summary>
    /// Class of extension rule for IndividualProperty.Core.4613
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class IndividualPropertyCore4613 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "IndividualProperty.Core.4613";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return @"The attribute metadata:type of metadata:value element for Collection of Scalar Values MUST be present.";
            }
        }
        ...
        /// <summary>
        /// Verify IndividualProperty.Core.4613
        /// </summary>
