...
namespace ODataValidator.Rule.EntityReference
{
    ...
    /// <summary>
    /// Class of entension rule for EntityReference.Core.4607
    /// </summary>
    [Export(typeof(ExtensionRule))]
    public class EntityReferenceCore4607 : ExtensionRule
    {
        /// <summary>
        ...
        public override string Name
        {
            get
            {
                return "EntityReference.Core.4607";
            }
        }
        ...
        public override string Description
        {
            get
            {
                return @"The atom:id of metadata:ref element for Entity Reference may be relative or absolute.";
            }
        }
        ...
        /// <summary>
        /// Verify EntityReference.Core.4607
        /// </summary>
